  ...
  return (
    <div>
      <div className="mb-6">
        ...
        <p className="mt-2 text-gray-600">查看和处理您的订单</p>
      </div>
      ...
      {orders.length === 0 ? (
        <div className="bg-white rounded-lg shadow p-12 text-center">
          ...
          <p className="mt-1 text-sm text-gray-500">等待商户下单</p>
        </div>
      ) : (
            ...
            return (
              <div key={order.id} className="bg-white rounded-lg shadow p-6">
                ...
                <div className="border-t border-gray-200 pt-4 mb-4">
                  <h4 className="text-sm font-medium text-gray-900 mb-2">商户信息</h4>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-500">商户名称：</span>
                      <span className="text-gray-900">{order.merchant.businessName || order.merchant.name}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">联系电话：</span>
                      <span className="text-gray-900">{order.merchant.phone || '未提供'}</span>
                    </div>
                  </div>
                </div>
